...
static constexpr auto qt_meta_stringdata_ZN6registE = QtMocHelpers::stringData(
    "regist"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6registE[] = {
...
Q_CONSTINIT const QMetaObject regist::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6registE.offsetsAndSizes,
    qt_meta_data_ZN6registE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6registE_t,
        // Q_OBJECT / Q_GADGET
...
void *regist::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6registE.stringdata0))
