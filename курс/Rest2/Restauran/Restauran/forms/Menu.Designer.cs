...
namespace restauran
{
    partial class Menu
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { iDFoodDataGridViewTextBoxColumn, nameFDataGridViewTextBoxColumn, costDataGridViewTextBoxColumn, descriptionDataGridViewTextBoxColumn, nameTypeDataGridViewTextBoxColumn });
            dataGridView1.DataSource = foodBindingSource;
            dataGridView1.EditMode = DataGridViewEditMode.EditOnEnter;
            dataGridView1.Location = new Point(213, 42);
            dataGridView1.Name = "dataGridView1";
            dataGridView1.ReadOnly = true;
            dataGridView1.Size = new Size(753, 577);
