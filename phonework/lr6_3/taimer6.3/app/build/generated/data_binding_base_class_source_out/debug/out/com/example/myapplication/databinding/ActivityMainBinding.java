...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Chronometer stopwatch;

  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull Button pauseButton, @NonNull Button resetButton, @NonNull Button startButton,
      @NonNull Chronometer stopwatch) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.stopwatch;
      Chronometer stopwatch = ViewBindings.findChildViewById(rootView, id);
      if (stopwatch == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, main, pauseButton, resetButton,
          startButton, stopwatch);
    }
