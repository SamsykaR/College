...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'ValidLogin'
        QtMocHelpers::SlotData<bool(const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Bool, {{
            { QMetaType::QString, 2 },
        }}),
        // Slot 'ValidEmail'
        ...
        // Slot 'ValidTelephone'
        QtMocHelpers::SlotData<bool(const QString &)>(4, 2, QMC::AccessPrivate, QMetaType::Bool, {{
            { QMetaType::QString, 2 },
        }}),
    };
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { bool _r = _t->ValidLogin((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: { bool _r = _t->ValidEmail((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { bool _r = _t->ValidTelephone((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
